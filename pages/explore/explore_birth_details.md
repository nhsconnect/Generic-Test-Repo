...
|  - meta | 0..1 | **Mandatory** | [Meta](http://hl7.org/fhir/stu3/resource.html#Meta) | <b><font color="red">The profile element MUST contain the value https://fhir.nhs.uk/STU3/StructureDefinition/CareConnect-NHSD-Encounter-1</font></b> |
...
|  - - system | 1..1 | **Mandatory** | [Uri](http://hl7.org/fhir/stu3/datatypes.html#uri) | The namespace for the identifier value. <b><font color="red">MUST contain the value 'https://tools.ietf.org/html/rfc4122'.</font></b> |
|  - - value | 1..1 | **Mandatory** | [String](http://hl7.org/fhir/stu3/datatypes.html#string) | The value that is unique. <b><font color="ref">MUST contain a UUID</font></b> |
...
|  - - coding (snomedCT) | 0..1 | **Mandatory** | [Coding](http://hl7.org/fhir/stu3/datatypes.html#coding) | [Code defined by a terminology system. Binding (required): The type of Child Health encounter <b><font color='red'.MUST contain the value '003'</font></b>( https://fhir.nhs.uk/STU3/ValueSet/DCH-ChildHealthEncounterType-1 )]( https://fhir.nhs.uk/STU3/ValueSet/DCH-ChildHealthEncounterType-1) |
|  - - system | 1..1 | **Mandatory** | [Uri](http://hl7.org/fhir/stu3/datatypes.html#uri) | Identity of the terminology system<br/><b><font color='red'>MUST contain the value 'https://fhir.nhs.uk/STU3/ValueSet/DCH-ChildHealthEncounterType-1'</font></b> |
